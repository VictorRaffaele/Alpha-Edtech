...
route.get("/info_client", index.list.list_client);
...
//Request Login
route.get("/login/:user/:password", index.login.login);
route.get("/login/:user", index.login.generateToken);
route.get("/loged", index.login.userType);
route.get("/logen_confirm", index.login.confUser);